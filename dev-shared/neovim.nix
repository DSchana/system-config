    ...
    programs.neovim = {
        ...
        extraLuaConfig = ''
            ...
            vim.api.nvim_create_autocmd('ColorScheme', {
              ...
              callback = function()
                ...
                vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = '#cba6f7', bold = true, bg = '#313244' })
              end,
            })
        ...
        -- Git signs
            require('gitsigns').setup({
                    ...
                    signs = {
                    add = { texthl = 'GitSignsAdd' },
                    query = { texthl = 'GitSignsChange' },
                    change = { texthl = 'GitSignsChange' },
                    delete = { texthl = 'GitSignsDelete' },
                    },
                    })
